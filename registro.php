...
<html lang="en">
  ...
  <body>
    ...
    <section class="container contact-us">
        <h4>Connect with Akko Official</h4>
        <div class="linea-contact"></div>
        <p>
            <span class="bold-text">Akko Representative will Respond to Your Requests within 24hrs (please note that there may be delays during weekends and national holidays).</span> <br>
            support@akkogear.com<br>
            <div>
            ...
            <span class="bold-text">Statement:</span> <br>
            Akko takes all technical support questions relevant to Akko products.<br>
            For warranty claim, if the orders were purchased from other authorized distributors/platforms (such as Banggood, Drop, Newegg etc), please consult the <br>distributors/platforms for RMA process and specific warranty terms. If your distributor, however, does not provide warranty service, you can report to us <br>by opening a ticket below.<br>
            <br>
            The website is operated by <span class="bold-text"> Shenzhen Yinchen Technology Co.</span>, Ltd located in 33 Langbi Rd, Shenzhen, Guangdong, China.
        </p>
    </section>
    ...
    <div class="container pt-5 pb-5">
        <div class="container-fluid">
            <form action="datos.php" method="post" novalidate class="needs-validation">
            <div class="row">
                <div class="col-md-6">
                <div class="mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12"> 
                    <div class="mb-3">
                        <label class="form-label" for="observaciones">Message*</label>
                        <textarea class="form-control" aria-label="With textarea" name="message" rows="4"></textarea>
                    </div>
                    </div>
                </div>
                <button type="submit" class="btn btn-primary bypass-color">Submit</button>
            </form>
        </div>
    </div>
